// Combined Bazi JS - All in one scope (Global)
/**
 * 八字命理数据大全
...
// ========== 十神关系表 ==========
// 以日干为太极点，看各天干与日干的关系
var SHI_SHEN = ['比肩', '劫财', '食神', '伤官', '偏财', '正财', '偏官', '正官', '偏印', '正印'];
...
// 驿马（年/日支查）
var YI_MA = { '寅午戌': '申', '申子辰': '寅', '巳酉丑': '亥', '亥卯未': '巳' };

// 桃花/咸池（年/日支查）
var TAO_HUA = { '寅午戌': '卯', '申子辰': '酉', '巳酉丑': '午', '亥卯未': '子' };

// 华盖（年/日支查）
var HUA_GAI = { '寅午戌': '戌', '申子辰': '辰', '巳酉丑': '丑', '亥卯未': '未' };

// 将星（年/日支查）
var JIANG_XING = { '寅午戌': '午', '申子辰': '子', '巳酉丑': '酉', '亥卯未': '卯' };

// 孤辰（年支查）
var GU_CHEN = { '亥子丑': '寅', '寅卯辰': '巳', '巳午未': '申', '申酉戌': '亥' };

// 寡宿（年支查）
var GUA_SU = { '亥子丑': '戌', '寅卯辰': '丑', '巳午未': '辰', '申酉戌': '未' };
...
// 天赦日
var TIAN_SHE = ['戊寅', '甲午', '戊申', '甲子'];

// 十恶大败日
var SHI_E_DA_BAI = ['甲辰', '乙巳', '壬申', '丙申', '丁亥', '庚辰', '戊戌', '癸亥', '辛亥', '辛巳', '己丑'];

// 魁罡日
var KUI_GANG = ['庚辰', '庚戌', '壬辰', '戊戌'];

// 阴阳差错日
var YIN_YANG_CHA_CUO = ['丙子', '丁丑', '戊寅', '辛卯', '壬辰', '癸巳', '丙午', '丁未', '戊申', '辛酉', '壬戌', '癸亥'];

// 孤鸾煞
var GU_LUAN = ['乙巳', '丁巳', '辛亥', '戊申', '壬寅', '戊午', '壬子', '丙午'];
...
// ========== 地支六冲 ==========
var DI_ZHI_LIU_CHONG = { '子': '午', '午': '子', '丑': '未', '未': '丑', '寅': '申', '申': '寅', '卯': '酉', '酉': '卯', '辰': '戌', '戌': '辰', '巳': '亥', '亥': '巳' };

// ========== 地支相刑 ==========
var DI_ZHI_XIANG_XING = {
